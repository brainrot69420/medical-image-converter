...
Incluye:
 - Procesamiento por lotes de un directorio, o archivo individual
 - Elección de formato de salida entre los tres disponibles
 - Inserción de fecha de adquisición de la imagen en el nombre de archivo de salida
 - Registro de logs de conversiones y errores en conversion.log
 """
